...
router.register(
    ...
    OrderWithOrderItemsView,
    'order_with_order_items'
)
router.register(
    'manage_orders_with_order_items',
    ManageOrderWithOrderItemsView,
    'manage_order_with_order_items'
)
router.register(
    'organisations_with_users',
    OrganisationWithUsersView,
    'organisation_with_users'
)
